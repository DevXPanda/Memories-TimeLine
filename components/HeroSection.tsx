      ...
      <div className="max-w-6xl mx-auto px-4 text-center relative z-10">
        ...
        >
          ...
          <p className="text-base sm:text-xl max-w-3xl mx-auto mb-12 leading-relaxed font-medium opacity-80" style={{ color: "var(--text-muted)" }}>
            Our Memories is your secure digital scrapbook and private messenger. Designed for couples, family and best friends, it&apos;s a completely E2EE safe place to share photos, deeply personal notes, and secret conversations.
          </p>
